    ...
    def is_valid_sudoku(board:list[list[str]]) -> bool:
        ...
        for row in range(9):
            for column in range(9):
                ...
                if location in rows[row] or location in columns[column] or location in squares[(row//3,column//3)]:
                    return False
                
                rows[row].add(location)
                columns[column].add(location)
                squares[(row//3,column//3)].add(location)
